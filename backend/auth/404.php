    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">Parece que la página que buscas no existe.</p>
                <a href="../" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Ir al inicio</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
